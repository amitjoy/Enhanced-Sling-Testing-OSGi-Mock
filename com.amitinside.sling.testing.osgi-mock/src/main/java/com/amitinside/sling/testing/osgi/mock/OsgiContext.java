...
public final class OsgiContext extends OsgiContextImpl implements TestRule {
	 ...
	 *
	 * @param setUpCallback
	 *            Allows the application to register an own callback function
	 *            that is called after the built-in setup rules are executed.
	 */
	 ...
	 *            Allows the application to register an own callback function
	 *            that is called before the built-in teardown rules are
	 *            executed.
	 */
